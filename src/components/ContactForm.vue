        ...
        <div class="contact-info">
          ...
          <div class="contact-item">
            ...
            <div class="contact-details">
              ...
              <p class="contact-text mb-2">Download my resume for more details about my experience and skills.</p>
              <a href="mailto:zhongqi1112@gmail.com?subject=Resume Request" class="resume-link">
                Request Resume
